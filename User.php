...
<div class="container"><br/><br/>
	<div class="row">
		<div class="col-sm-12 text-right"><button onclick="window.location.href='EditPro.php'" class="btn btn-primary editProfileBtn" role="button" border="0" ><i class="fa fa-edit"></i> Edit Profile</div>
	</div>
